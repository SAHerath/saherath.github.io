  ...
  return (
    <section>
      <div className="min-h-screen pt-10 px-6 sm:px-8 md:px-16 xl:px-32">
        ...
        <div className="flex flex-col justify-center gap-4 sm:text-lg py-8 lg:py-4">
          <p>Let's connect!</p>
          <p>Reach out via email or follow me on social media to discuss projects, ideas, or simply say hello.</p>
        </div>
        
        <div className="flex justify-center items-stretch gap-6 xl:gap-12 rounded-lg p-5 h-32">
