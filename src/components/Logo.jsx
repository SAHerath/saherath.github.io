  ...
  return (
    <svg width={400*scale} height={300*scale} xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g transform={"scale("+scale+")"} fill="currentColor" stroke="none">
        ...
        {animate &&
          <>
          <animateMotion id="anim1" path="M 0 0 V -60" calcMode="linear" begin="0s; anim3.end" dur="0.7s" fill="freeze"/>
          <animateMotion id="anim2" path="M 0 -60 V 60" calcMode="linear" begin="anim1.end" dur="1.4s" fill="freeze"/>
          <animateMotion id="anim3" path="M 0 60 V 0" calcMode="linear" begin="anim2.end" dur="0.7s" fill="freeze"/>
          </>
        }
        </path>
        ...
        {animate &&
          <>  
          <animateMotion id="anim4" path="M 0 0 L -16 50" calcMode="linear" begin="0s; anim5.end" dur="0.8s" fill="freeze"/>
          <animateMotion id="anim5" path="M -16 50 L 0 0" calcMode="linear" begin="anim4.end" dur="0.8s" fill="freeze"/>
          </>
        }
        </path>
      </g>
